...
#define STRING_CONFIG_H_AUTHOR "(Spiike Build)" // Who made the changes.
...
#define X_MIN_POS -6.8
#define Y_MIN_POS -21.2
#define Z_MIN_POS 0
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define LEVELED_SEGMENT_LENGTH 27.5 // (mm) Length of all segments (except the last one)
